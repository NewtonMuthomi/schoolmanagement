...
<br><br>
<div class="heading">
    <h2 class="text-center">Invoice Details Report</h2>
</div>
<div class="container">
    <?php
    ...
    $result = mysqli_query($con,"SELECT * FROM accounts where invoice_date>='$_POST[jdatefrom]' and invoice_date<='$_POST[jdateto]'");
...
<div class="text-center">
    <tr>
        <a href="report_invoicesearch_sysadmin.php" class="btn btn-success" type="submit">Pick a different date range</a>
    </tr>
</div>
