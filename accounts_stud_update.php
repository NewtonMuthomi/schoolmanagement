...
<div class="container">
    ...
    {
        $sql="insert into accounts(admin_no,first_name,other_names,course,invoice_date,tution_fees,registration_fees,hostel_fees,library_fees,total_amount)
values('$_POST[admin]','$_POST[fname]','$_POST[onames]','$_POST[course]','$_POST[idate]','$_POST[tfees]','$_POST[rfees]','$_POST[hfees]','$_POST[lfees]','$_POST[amount]')";
        if($conn->query($sql)==true)
        {
            print "Student Invoice Details Submitted Successfully! <br><br>";
            print "<a href='accounts_dashboard.php' class='btn btn-primary'>New Invoice</a><br>";
        }
        else
        {
