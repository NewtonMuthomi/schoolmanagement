...
<table>
    <tr>
        <td class="text-left"><a href="management_enquirysearch_rep.php" class="btn btn-success" type="submit">Pick a different date range</a></td>
        <td class="text-right"><a href="management_dashboard.php" class="btn btn-success" type="submit">Back to main page</a></td>
    </tr>
</table>
</body>
</html>